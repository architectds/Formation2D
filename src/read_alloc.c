...
void read_alloc(char *filename, Model_Data DS, Control_Data *CS)
	...
	timeinfo = (struct tm *)malloc(sizeof(struct tm));
  	...
  	fn[0] = (char *)malloc((strlen(filename)+20)*sizeof(char));
	strcpy(fn[0],"input/");
  	strcat(fn[0], filename);
  	...
  	fn[1] = (char *)malloc((strlen(filename)+20)*sizeof(char));
	strcpy(fn[1],"input/");
  	strcat(fn[1], filename);
  	...
  	fn[2] = (char *)malloc((strlen(filename)+20)*sizeof(char));
	strcpy(fn[2],"input/");
  	strcat(fn[2], filename);
  	...
  	fn[3] = (char *)malloc((strlen(filename)+20)*sizeof(char));
	strcpy(fn[3],"input/");
  	strcat(fn[3], filename);
...
//		fscanf(soil_file, "%lf", &(DS->Soil[i].PsiS));
  		} 
  	...
  	printf("done.\n");
        ...
        fn[4] = (char *)malloc((strlen(filename)+20)*sizeof(char));
	strcpy(fn[4],"input/");
  	strcat(fn[4], filename);
  	...
  	fn[5] = (char *)malloc((strlen(filename)+20)*sizeof(char));
	strcpy(fn[5],"input/");
  	strcat(fn[5], filename);
  	...
  	fn[6] = (char *)malloc((strlen(filename)+20)*sizeof(char));
	strcpy(fn[6],"input/");
  	strcat(fn[6], filename);
  	...
  	fscanf(forc_file, "%d %d", &DS->NumSdown, &DS->NumLdown);
  	...
  	DS->TSD_Sdown = (TSD *)malloc(DS->NumSdown*sizeof(TSD));
  	DS->TSD_Ldown = (TSD *)malloc(DS->NumLdown*sizeof(TSD));
  	...
  	for(i=0; i<DS->NumPrep; i++)
  		{
    		...
    		for(j=0; j<DS->TSD_Prep[i].length; j++)
    			{
			fscanf(forc_file, "%d-%d-%d %d:%d:%d %lf", &timeinfo->tm_year,&timeinfo->tm_mon,&timeinfo->tm_mday,&timeinfo->tm_hour,&timeinfo->tm_min,&timeinfo->tm_sec,&DS->TSD_Prep[i].TS[j][1]);
			timeinfo->tm_year = timeinfo->tm_year - 1900;
			timeinfo->tm_mon = timeinfo->tm_mon - 1;
			rawtime = timegm(timeinfo);
			DS->TSD_Prep[i].TS[j][0] = (realtype)rawtime/60/60/24;
    			}
  		}  
  	...
  	for(i=0; i<DS->NumTemp; i++)
  		{
    		...
    		for(j=0; j<DS->TSD_Temp[i].length; j++)
    			{
			fscanf(forc_file, "%d-%d-%d %d:%d:%d %lf", &timeinfo->tm_year,&timeinfo->tm_mon,&timeinfo->tm_mday,&timeinfo->tm_hour,&timeinfo->tm_min,&timeinfo->tm_sec, &DS->TSD_Temp[i].TS[j][1]);
			timeinfo->tm_year = timeinfo->tm_year - 1900;
			timeinfo->tm_mon = timeinfo->tm_mon - 1;
			rawtime = timegm(timeinfo);
			DS->TSD_Temp[i].TS[j][0] = (realtype)rawtime/60/60/24;
    			}
  		} 
  	...
  	for(i=0; i<DS->NumHumidity; i++)
  		{
    		...
    		for(j=0; j<DS->TSD_Humidity[i].length; j++)
    			{
      			fscanf(forc_file, "%d-%d-%d %d:%d:%d %lf", &timeinfo->tm_year,&timeinfo->tm_mon,&timeinfo->tm_mday,&timeinfo->tm_hour,&timeinfo->tm_min,&timeinfo->tm_sec, &DS->TSD_Humidity[i].TS[j][1]);
			timeinfo->tm_year = timeinfo->tm_year - 1900;
			timeinfo->tm_mon = timeinfo->tm_mon - 1;
			rawtime = timegm (timeinfo);
			DS->TSD_Humidity[i].TS[j][0] = (realtype)rawtime/60/60/24;
    			}
  		} 
  	...
  	for(i=0; i<DS->NumWindVel; i++)
  		{
    		...
    		for(j=0; j<DS->TSD_WindVel[i].length; j++)
    			{
      			fscanf(forc_file, "%d-%d-%d %d:%d:%d %lf", &timeinfo->tm_year,&timeinfo->tm_mon,&timeinfo->tm_mday,&timeinfo->tm_hour,&timeinfo->tm_min, &timeinfo->tm_sec,&DS->TSD_WindVel[i].TS[j][1]);
			timeinfo->tm_year = timeinfo->tm_year - 1900;
			timeinfo->tm_mon = timeinfo->tm_mon - 1;
			rawtime = timegm (timeinfo);
			DS->TSD_WindVel[i].TS[j][0] = (realtype)rawtime/60/60/24;
    			}
  		} 

  	for(i=0; i<DS->NumSdown; i++)
  		{
    		fscanf(forc_file, "%s %d %d", DS->TSD_Sdown[i].name, &DS->TSD_Sdown[i].index, &DS->TSD_Sdown[i].length);
    
    		DS->TSD_Sdown[i].TS = (realtype **)malloc((DS->TSD_Sdown[i].length)*sizeof(realtype));
    
    		for(j=0; j<DS->TSD_Sdown[i].length; j++)
    			{
      			DS->TSD_Sdown[i].TS[j] = (realtype *)malloc(2*sizeof(realtype));
    			}
    
    		for(j=0; j<DS->TSD_Sdown[i].length; j++)
    			{
      			fscanf(forc_file, "%d-%d-%d %d:%d:%d %lf", &timeinfo->tm_year,&timeinfo->tm_mon,&timeinfo->tm_mday,&timeinfo->tm_hour,&timeinfo->tm_min,&timeinfo->tm_sec, &DS->TSD_Sdown[i].TS[j][1]);
			timeinfo->tm_year = timeinfo->tm_year - 1900;
			timeinfo->tm_mon = timeinfo->tm_mon - 1;
			rawtime = timegm (timeinfo);
			DS->TSD_Sdown[i].TS[j][0] = (realtype)rawtime/60/60/24;
    			}
  		} 

  	for(i=0; i<DS->NumLdown; i++)
  		{
    		fscanf(forc_file, "%s %d %d", DS->TSD_Ldown[i].name, &DS->TSD_Ldown[i].index, &DS->TSD_Ldown[i].length);
    
    		DS->TSD_Ldown[i].TS = (realtype **)malloc((DS->TSD_Ldown[i].length)*sizeof(realtype));
    
    		for(j=0; j<DS->TSD_Ldown[i].length; j++)
    			{
      			DS->TSD_Ldown[i].TS[j] = (realtype *)malloc(2*sizeof(realtype));
    			}
    
    		for(j=0; j<DS->TSD_Ldown[i].length; j++)
    			{
      			fscanf(forc_file, "%d-%d-%d %d:%d:%d %lf", &timeinfo->tm_year,&timeinfo->tm_mon,&timeinfo->tm_mday,&timeinfo->tm_hour,&timeinfo->tm_min,&timeinfo->tm_sec, &DS->TSD_Ldown[i].TS[j][1]);
			timeinfo->tm_year = timeinfo->tm_year - 1900;
			timeinfo->tm_mon = timeinfo->tm_mon - 1;
			rawtime = timegm (timeinfo);
			DS->TSD_Ldown[i].TS[j][0] = (realtype)rawtime/60/60/24;
    			}
  		} 
  	...
  	for(i=0; i<DS->NumP; i++)
  		{
    		...
    		for(j=0; j<DS->TSD_Pressure[i].length; j++)
    			{
      			fscanf(forc_file, "%d-%d-%d %d:%d:%d %lf", &timeinfo->tm_year,&timeinfo->tm_mon,&timeinfo->tm_mday,&timeinfo->tm_hour,&timeinfo->tm_min,&timeinfo->tm_sec, &DS->TSD_Pressure[i].TS[j][1]);
			timeinfo->tm_year = timeinfo->tm_year - 1900;
			timeinfo->tm_mon = timeinfo->tm_mon - 1;
			rawtime = timegm (timeinfo);
			DS->TSD_Pressure[i].TS[j][0] = (realtype)rawtime/60/60/24;
    			}
  		} 
  	...
  	for(i=0; i<DS->NumLC; i++)
  		{
    		...
    		for(j=0; j<DS->TSD_LAI[i].length; j++)
    			{
      			fscanf(forc_file, "%d-%d-%d %d:%d:%d %lf", &timeinfo->tm_year,&timeinfo->tm_mon,&timeinfo->tm_mday,&timeinfo->tm_hour,&timeinfo->tm_min,&timeinfo->tm_sec, &DS->TSD_LAI[i].TS[j][1]);
			timeinfo->tm_year = timeinfo->tm_year - 1900;
			timeinfo->tm_mon = timeinfo->tm_mon - 1;
			rawtime = timegm (timeinfo);
			DS->TSD_LAI[i].TS[j][0] = (realtype)rawtime/60/60/24;
    			}
  		} 
  	...
  	for(i=0; i<DS->NumLC; i++)
  		{
    		...
    		for(j=0; j<DS->TSD_RL[i].length; j++)
    			{
      			fscanf(forc_file, "%d-%d-%d %d:%d:%d %lf", &timeinfo->tm_year,&timeinfo->tm_mon,&timeinfo->tm_mday,&timeinfo->tm_hour,&timeinfo->tm_min,&timeinfo->tm_sec, &DS->TSD_RL[i].TS[j][1]);
			timeinfo->tm_year = timeinfo->tm_year - 1900;
			timeinfo->tm_mon = timeinfo->tm_mon - 1;
			rawtime = timegm (timeinfo);
			DS->TSD_RL[i].TS[j][0] = (realtype)rawtime/60/60/24;
    			}
  		} 
  	...
  	for(i=0; i<DS->NumMeltF; i++)
  		{
    		...
    		for(j=0; j<DS->TSD_MeltF[i].length; j++)
    			{
      			fscanf(forc_file, "%d-%d-%d %d:%d:%d %lf", &timeinfo->tm_year,&timeinfo->tm_mon,&timeinfo->tm_mday,&timeinfo->tm_hour,&timeinfo->tm_min,&timeinfo->tm_sec, &DS->TSD_MeltF[i].TS[j][1]);
			timeinfo->tm_year = timeinfo->tm_year - 1900;
			timeinfo->tm_mon = timeinfo->tm_mon - 1;
			rawtime = timegm (timeinfo);
			DS->TSD_MeltF[i].TS[j][0] = (realtype)rawtime/60/60/24;
    			}
  		} 
  	...
  	for(i=0; i<DS->NumSource; i++)
  		{
    		...
    		for(j=0; j<DS->TSD_Source[i].length; j++)
    			{
      			fscanf(forc_file, "%d-%d-%d %d:%d:%d %lf", &timeinfo->tm_year,&timeinfo->tm_mon,&timeinfo->tm_mday,&timeinfo->tm_hour,&timeinfo->tm_min,&timeinfo->tm_sec, &DS->TSD_Source[i].TS[j][1]);
			timeinfo->tm_year = timeinfo->tm_year - 1900;
			timeinfo->tm_mon = timeinfo->tm_mon - 1;
			rawtime = timegm (timeinfo);
			DS->TSD_Source[i].TS[j][0] = (realtype)rawtime/60/60/24;
    			}
  		} 
  	...
  	fn[7] = (char *)malloc((strlen(filename)+20)*sizeof(char));
	strcpy(fn[7],"input/");
  	strcat(fn[7], filename);
  	...
  	fn[8] = (char *)malloc((strlen(filename)+20)*sizeof(char));
	strcpy(fn[8],"input/");
  	strcat(fn[8], filename);
...
//	printf("start = %f, end = %f",CS->StartTime,CS->EndTime);
	...
	printf("\n  10) reading %s.calib ... ", filename);
        fn[9] = (char *)malloc((strlen(filename)+20)*sizeof(char));
	strcpy(fn[9],"input/");
  	strcat(fn[9], filename);
	...
	fscanf(global_calib,"%lf %lf",&CS->Cal.TF,&CS->Cal.IS);
	fscanf(global_calib,"%lf %lf %lf %lf",&CS->Cal.Rmin,&CS->Cal.Czil,&CS->Cal.fx_soil,&CS->Cal.fx_canopy);
	fscanf(global_calib,"%lf %lf %lf %lf %lf",&CS->Cal.Rs_ref,&CS->Cal.h_s,&CS->Cal.Tref,&CS->Cal.ThetaRef,&CS->Cal.ThetaW);
